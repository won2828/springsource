...
public class ReviewController {
    ...
    // ~~~/reviews/45(mno)/57(reviewno) + @DeleteMapping
    ...
    // ~~/reviews/45(mno)/57(reviewno) + @GetMapping
    @GetMapping("/{mno}/{reviewNo}")
    public ReviewDto getMethodName(@PathVariable Long mno, @PathVariable Long reviewNo) {
